...
public final class MockedType
{
   ...
   @Nullable final Capturing capturing;
   @Nullable final Cascading cascading;
   ...
   @Nullable
   private <A extends Annotation> A getAnnotation(@NotNull Annotation[] annotations, @NotNull Class<A> annotation)
   {
