...
final class ReturnTypeConversion
{
   ...
   @NotNull private Object addArrayElements(@NotNull Collection<Object> values, int elementCount)
   {
   ...
   @Nullable private Object addArrayElements(@NotNull Map<Object, Object> values, int elementPairCount)
   {
   ...
   private void addCharSequence(@NotNull CharSequence value)
   {
   ...
   @Nullable private Object convertFromNumber(@NotNull Class<?> targetType, @NotNull Number number)
   {
   ...
   @Nullable private Object convertFromChar(@NotNull Class<?> targetType, char c)
   {
      if (targetType == Integer.class) {
         return (int) c;
      }
