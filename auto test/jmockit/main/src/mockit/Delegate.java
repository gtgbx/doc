 ...
 * </pre>
 * The delegate class (either named or anonymous) must contain exactly one non-<code>private</code> delegate method to
 ...
 * <p/>
 * Finally, note that {@code static} methods in the mocked type can also have delegates, which in turn can be static or
 * not.
 * The same is true for {@code private}, {@code final}, and {@code native} methods.
 *
 * @see <a href="http://jmockit.googlecode.com/svn/trunk/www/tutorial/BehaviorBasedTesting.html#delegates">Tutorial</a>
 *
