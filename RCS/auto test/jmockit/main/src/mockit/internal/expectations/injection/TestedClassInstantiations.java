...
public final class TestedClassInstantiations
{
   ...
   {
      @NotNull private final Class<?> declaredClass;
      @NotNull private final Class<?> actualClass;
      ...
      private Class<?> generateSubclass(@NotNull Type testedType)
      {
         ...
         return ImplementationClass.defineNewClass(declaredClass.getClassLoader(), bytecode, subclassName);
      }
      ...
      private final class ConstructorSearch
      {
         ...
         @Nullable private List<MockedType> findAvailableInjectablesForConstructor(@NotNull Constructor<?> candidate)
         {
