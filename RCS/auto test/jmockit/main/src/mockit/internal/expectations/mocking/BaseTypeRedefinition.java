...
abstract class BaseTypeRedefinition
{
   ...
   BaseTypeRedefinition(@NotNull Class<?> mockedType) { targetClass = mockedType; }
   ...
   @Nullable
   private Class<?> interfaceToMock(@NotNull Type typeToMock)
   {
   ...
   @NotNull
   abstract ExpectationsModifier createModifier(@NotNull Class<?> realClass, @NotNull ClassReader classReader);
   ...
   @NotNull
   private ClassReader createClassReader(@NotNull Class<?> realClass)
   {
